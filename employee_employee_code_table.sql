...
CREATE TABLE `employee_code_table` (
  ...
  `employee_code_name` varchar(20) DEFAULT NULL,
  `employee_domain` varchar(20) DEFAULT NULL,
...
INSERT INTO `employee_code_table` VALUES ('su_daenerys','du_daenerys','su_daenerys'),('su_john','ru_john','Java');
