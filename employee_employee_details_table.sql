...
CREATE TABLE `employee_details_table` (
  ...
  `Graduation_percentile` decimal(5,2) DEFAULT NULL,
...
INSERT INTO `employee_details_table` VALUES ('RU122','John','Snow',60.00),('RU123','Daenerys','Targaryen',88.00);
...
-- Dump completed on 2023-03-30 12:31:33
